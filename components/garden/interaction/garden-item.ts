...
// This small shared shape crosses the seam between 3D life and the HTML card.
export type GardenItem = GardenItemDetails & {
  // Kind lets the interface use language appropriate to a flower or tree.
  kind: GardenItemKind;
};
